...
values (pk_sequence.nextval, 'Alice', 'Pleasance Liddell', 'Wonderland, 2', 'alice_inwonderland@mail.com', 1);
insert into customer(id, name, surname, address, email, user)
values (pk_sequence.nextval, 'The March', 'Hare', 'Dining Table, 1', 'march_hare@mail.com', 2);
insert into customer(id, name, surname, address, email, user)
values (pk_sequence.nextval, 'The Mad', 'Hatter', 'Dining Table, 2', 'mad_hatter@mail.com', 3);
insert into wallet(id, balance, customer, version)
values (pk_sequence.nextval, 1000, 4, 0);
insert into wallet(id, balance, customer, version)
values (pk_sequence.nextval, 750, 5, 0);
insert into wallet(id, balance, customer, version)
values (pk_sequence.nextval, 500, 6, 0);
insert into transaction(id, amount, timestamp, sender, receiver)
values (pk_sequence.nextval, 50, '2020-01-01 00:00:00', 7, 8);
insert into transaction(id, amount, timestamp, sender, receiver)
