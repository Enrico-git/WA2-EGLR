...
values (1, "Alice", "Pleasance Liddell", "Wonderland, 2", "alice_inwonderland@mail.com");
insert into customer(id, name, surname, address, email)
values (2, "The March", "Hare", "Dining Table, 1", "march_hare@mail.com");
insert into customer(id, name, surname, address, email)
values (3, "The Mad", "Hatter", "Dining Table, 2", "mad_hatter@mail.com");
...
values (1, 50, "2020-01-01 00:00:00", 1, 2);
insert into transaction(id, amount, timestamp, sender, receiver)
values (2, 250, "2020-01-01 00:00:00", 1, 3);
