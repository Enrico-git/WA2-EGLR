...
class AuthController(
    ...
    fun createUser(@RequestBody @Valid registrationDTO: RegistrationDTO): ResponseEntity<UserDetailsDTO> {
    ...
    fun registrationConfirm(@RequestParam token: String): ResponseEntity<Unit> {
